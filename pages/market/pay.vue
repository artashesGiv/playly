<template>
  <div class="market-pay">
    ...
    <ui-button-base
      ...
      :loading="isLoading"
      size="52"
      @click="onPay(params as MarketItem)"
    />
  </div>
</template>
...
const { onPay } = useMarketStore()

const { t } = useI18n()

const route = useRoute()
const params = JSON.parse(route.query.item as string) as Partial<MarketItem>

const currencyMap: Record<MarketItem['currency'], string> = {
  RUB: '₽',
  USD: '$',
}
