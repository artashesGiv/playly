...
export declare function useMotionState(props: MotionProps): {
    getProps: () => {
        ...
        layoutId: string;
        transition: import('motion-dom').StyleTransitions & import('motion-dom').SVGPathTransitions & import('motion-dom').SVGForcedAttrTransitions & import('motion-dom').SVGTransitions & import('motion-dom').VariableTransitions & import('motion-dom').ValueAnimationTransition<any> & {
