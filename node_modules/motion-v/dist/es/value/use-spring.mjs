...
import { animateValue } from "../external/.pnpm/motion-dom@12.18.1/external/motion-dom/dist/es/animation/JSAnimation.mjs";
...
import { frame, frameData } from "../external/.pnpm/motion-dom@12.18.1/external/motion-dom/dist/es/frameloop/frame.mjs";
function toNumber(v) {
  if (typeof v === "number")
    return v;
  return parseFloat(v);
