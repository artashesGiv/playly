export type BiometricManager = {
    ...
    requestAccess: (params: BiometricRequestAccessParams, callback?: BiometricManagerCallback['requestAccess']) => BiometricManager;
    authenticate: (params: BiometricAuthenticateParams, callback?: BiometricManagerCallback['authenticate']) => BiometricManager;
    updateBiometricToken: (token: string, callback?: BiometricManagerCallback['updateBiometricToken']) => BiometricManager;
